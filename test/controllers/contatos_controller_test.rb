...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { nome: @contato.nome, email: @contato.email, mensagem: @contato.mensagem }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { email: @contato.email, mensagem: @contato.mensagem, nome: @contato.nome }
